...
I did this before but I totally forgot
I am thinking that 132 problem.. maybe sub and replace... sort of...
hmm... hmmm...

but I see the O(n^2) solution now
"""
...
"""
TLE.. 54/55 cases passed.. hmm.. why would it TLE   
>>> len(a)
2464
"""
...
"""
Runtime: 78 ms, faster than 95.73% of Python3 online submissions for Longest Increasing Subsequence.
Memory Usage: 14.3 MB, less than 47.61% of Python3 online submissions for Longest Increasing Subsequence.

and yes, the 132 pattern
"""
...
class Solution:
    def lengthOfLIS(self, nums: List[int]) -> int:
        ...
        for i in range(1, len(nums)):
            ...
            heapq.heapify(hCopy)
            while hCopy:
                preLis, val = heapq.heappop(hCopy)
                preLis = -preLis
                if nums[i] > val:
                    lis += preLis
                    break
...
"""
Runtime: 8915 ms, faster than 5.01% of Python3 online submissions for Longest Increasing Subsequence.
Memory Usage: 14.8 MB, less than 5.30% of Python3 online submissions for Longest Increasing Subsequence.

nice.. a different solution at least
using heap is kind of troublesome..
let me use that SortedList
"""
...
"""
Runtime: 955 ms, faster than 64.79% of Python3 online submissions for Longest Increasing Subsequence.
Memory Usage: 14.9 MB, less than 5.30% of Python3 online submissions for Longest Increasing Subsequence.

Runtime: 692 ms, faster than 65.00% of Python3 online submissions for Longest Increasing Subsequence.
Memory Usage: 14.9 MB, less than 5.30% of Python3 online submissions for Longest Increasing Subsequence.
"""
